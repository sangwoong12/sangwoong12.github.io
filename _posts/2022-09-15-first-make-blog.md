...
<img src="/images/first-make-blog/1.png" width="100%" height="100%">
...
<img src="/images/first-make-blog/2.png" width="100%" height="100%">
...
<img src="/images/first-make-blog/3.png" width="100%" height="100%">

그림처럼 검색하여 앱을 실행한다.

<img src="/images/first-make-blog/4.png" width="100%" height="100%">

실행하면 다음과 같은 화면이 등장한다. 
> 1. 좌측 상단에 있는 current repository에 있는 ▼를 클릭한다. 
> 2. 이후 Add ▼ 를 눌려 Clone repository를 누른다.

<img src="/images/first-make-blog/5.png" width="100%" height="100%">
...
<img src="/images/first-make-blog/6.png" width="100%" height="100%">
...
<img src="/images/first-make-blog/7.png" width="100%" height="100%">
...
<img src="/images/first-make-blog/8.png" width="100%" height="100%">
